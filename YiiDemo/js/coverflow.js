...
*/
/**
 * @method switch Web Desktop background
 * @author modified by Charlie Chen
 * 2012-12-07
 */
    ...
    $.fn.extend({
        ...
        coveflow:function (opts) {	
            ...
            var move=function(num){
                ...
                $(elem[num]).addClass('flat').removeClass('turnRight').removeClass('turnLeft').css({
                    zIndex:elng,
                ...
                for(i=0;i<num;i++){
                    ...
                    $(elem[i]).addClass('turnLeft').removeClass('turnRight').removeClass('flat').css({
                        zIndex:i+1,
                ...
                for(i=elng-1;i>num;i--){
                    ...
                    $(elem[i]).addClass('turnRight').removeClass('turnLeft').removeClass('flat').css({
                        zIndex:elng-i,
                        '-webkit-transform':'translateX('+left+'px) scale('+options.scale+')'
                    });
                };
